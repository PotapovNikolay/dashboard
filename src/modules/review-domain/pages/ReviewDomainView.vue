<template>
    <div v-if="domain" class="category-view__name form-group">
        <app-input label="Название" v-model:value="domain.name" :error="errors.name" :minWidth="255"></app-input>
    </div>

    <div v-if="domain" class="category-view__name form-group">
        <app-input label="Название" v-model:value="domain.host" :error="errors.name" :minWidth="255"></app-input>
    </div>
